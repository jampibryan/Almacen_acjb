<x-app-layout>
    ...
    <a href="{{ route('categorias.create') }}" class="w-16 bg-blue-600 py-2 px-4 italic text-2xl">REGISTRAR CATEGORÍA</a>
            ...
            <tbody>
                @foreach ($categorias as $categoria)
                    <tr>
                        ...
                        <td class="border text-center px-4 py-2 italic text-2xl text-white">{{ $categoria->codigoc }}</td>
                        <td class="border text-center px-4 py-2 italic text-2xl text-white">{{ $categoria->nombre }}</td>
                        </td>
                        <td class="border text-center px-4 py-2 italic text-base">
                            <a href="{{ route('categorias.edit', $categoria) }}" class="bg-blue-500 p-2">Editar</a>
